...
public class CategorySelectListViewAdapter extends ArrayAdapter<Category> {
    private Context context;

    public CategorySelectListViewAdapter(Context context, int resource, List<Category> categories) {
